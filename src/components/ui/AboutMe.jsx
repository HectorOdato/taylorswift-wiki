...
export const AboutMe = () => {
    return (
        <div className="flex relative z-5 w-full items-center justify-center bg-orange-600/80 p-10 space-x-10 rounded-lg max-w-7xl mx-auto ">
            <div>
            ...
            <div>
                <p className="text-black max-w-4xl text-center">
