    ...
    return (
        <main className={`min-h-screen ${PageBackground.font_black} text-white p-8`}>
            <section className="flex items-center justify-center mx-auto mt-10 mb-10">
                <div>
                    <img src="https://res.cloudinary.com/deijzj2mb/image/upload/v1770171269/GettyImages-2014750039-da654c28b8f84f3fb5c7db97106b1abc_yzricu.jpg" alt="Taylor Swift Biography" className="w-200 h-200 object-cover rounded-xl"/>
                </div>
            ...
            <ContentSection
                ...
                classNameImage={floatimage.float_right}
                />
                <br />
                <ContentSection
                    ...
                    classNameImage={floatimage.float_left}
                />
                <ContentSection 
                ...
                classNameImage={floatimage.float_right}
                />
                <section className="flex flex-col items-center max-w-6xl mx-auto mt-16 mb-10 px-6 relative z-10 text-gray-200 leading-loose text-lg ">
                    <h2 className="text-center text-pink-400 text-4xl font-bold mb-8">Como comenzo la carrera de Taylor Swift </h2>
        ...
        <section>
            ...
            classNameImage={floatimage.float_left}
            />
            <img src="https://res.cloudinary.com/deijzj2mb/image/upload/v1770172072/2016_Grammy_Awards_red_carpet_4_jnyvki.webp" alt="image-grammy" className="max-w-4xl mx-10"/>
            <br />
            </section>
            <section >
            <ContentSection
